...
#[derive(Show, Copy, Eq, PartialEq, Clone, Ord, PartialOrd)]
...
impl fmt::Debug for ExprNode {
    fn fmt(&self, f: &mut Formatter) -> fmt::Result {
        match *self {
            ...
            BinOpExpr(ref op, ref l, ref r)     => write!(f, "({:?}{:?}{:?})", l, op, r),
            UnOpExpr(ref op, ref e)             => write!(f, "({:?}{:?})", op, e),
